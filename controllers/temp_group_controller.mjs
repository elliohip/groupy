...
export const create_temp_group = async_handler(async(req, res, next) => {
...
export const add_user_to_temp_group = async_handler(async (req, res, next) => {
...
export const remove_from_temp_group = async_handler(async(req, res, next) => {
    let temp_group = await TempGroup.findOneById(req.body.group_id);
...
export const get_temp_group = async_handler(async (req, res, next) => {
